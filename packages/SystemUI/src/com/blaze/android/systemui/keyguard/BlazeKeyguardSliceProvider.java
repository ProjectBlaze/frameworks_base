package com.blaze.android.systemui.keyguard;
...
public class BlazeKeyguardSliceProvider extends KeyguardSliceProvider implements SmartSpaceUpdateListener {
    ...
    public Slice onBindSlice(Uri uri) {
        ...
        Trace.beginSection("BlazeKeyguardSliceProvider#onBindSlice");
    ...
    private static class AddShadowTask extends AsyncTask<Bitmap, Void, Bitmap> {
        ...
        private final WeakReference<BlazeKeyguardSliceProvider> mProviderReference;
        private final SmartSpaceCard mWeatherCard;

        AddShadowTask(BlazeKeyguardSliceProvider blazeKeyguardSliceProvider, SmartSpaceCard smartSpaceCard) {
            this.mProviderReference = new WeakReference<>(blazeKeyguardSliceProvider);
            this.mWeatherCard = smartSpaceCard;
            this.mBlurRadius = blazeKeyguardSliceProvider.getContext().getResources().getDimension(R.dimen.smartspace_icon_shadow);
        }
        ...
        public void onPostExecute(Bitmap bitmap) {
            BlazeKeyguardSliceProvider blazeKeyguardSliceProvider;
            synchronized (this) {
                this.mWeatherCard.setIcon(bitmap);
                blazeKeyguardSliceProvider = this.mProviderReference.get();
            }
            if (blazeKeyguardSliceProvider != null) {
                blazeKeyguardSliceProvider.notifyChange();
            }
        }
